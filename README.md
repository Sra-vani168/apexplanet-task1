This is a simple web project created as part of my ApexPlanet internship Task 1. It includes basic use of HTML, CSS, and JavaScript to build a basic web page.
